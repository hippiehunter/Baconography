	...
	public class ExpanderView : HeaderedItemsControl
	{
		...
		public bool IsExpanded
		{
			...
			set
			{
				...
				{
					throw new InvalidOperationException("InvalidExpanderViewOperation");
				}
			}
		}
		...
		private void OnSizeChanged(object sender, SizeChangedEventArgs e)
		{
			if (_presenter != null)
			{
				ExpanderView parent = FindParent<ExpanderView>(_presenter);
		...
		internal void AnimateContainerDropDown()
		{
			for (int i = 0; i < Items.Count; i++)
			{
				...
				Storyboard.SetTargetProperty(transAnimation, "TranslateTransform.YProperty");
				...
				Storyboard.SetTargetProperty(opacityAnimation, "FrameworkElement.OpacityProperty");
